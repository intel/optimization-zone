...
1.  Download the CQL timeseries schema

```
java -jar nb.jar  --copy cql-timeseries2
```

2.  Change the compressor to use "Deflate".
...
4.  Pre-populate dataset with progress reported every 4s
...
```
4. Run the workload (mixed 80R/20W)
